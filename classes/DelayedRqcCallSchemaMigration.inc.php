...
class DelayedRqcCallSchemaMigration extends Migration
{
	...
	public function up(): void
	{
		...
		// there has to be a _settings table in the db (if not there are errors with some SchemaDAO-methods) TODO 2: forum question to make pull-request so that one can have a custom table without settings via SchemaDAO
